...
impl Solver {
    fn solve(&mut self) {
        ...
        delta_mp.insert(36, 96);
        delta_mp.insert(49, 139);
        delta_mp.insert(64, 118);
        delta_mp.insert(81, 234);
        delta_mp.insert(100, 242);
        ...
        n_mp.insert(81, 7);
        n_mp.insert(100, 13);
        let n = if n_mp.contains_key(&S) { n_mp[&S] } else { 15 };
